...
> **Category**: Reversing
>
> **Flag**: `d3ctf{mach_actor_vm_pacman_rc4_decrypted}`
...
1. **App Structure**: Unzipping `pacman.ipa` reveals the iOS application binary at `Payload/MachActorVM.app/MachActorVM`.
2. **Core Logic**:
